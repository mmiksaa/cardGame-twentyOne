...
import { Button } from '../';
import { onRestartGame } from '../../redux/cardsSlice';
import './endGame.scss';
...
function EndGame() {
  ...
  const onStartNewGame = () => dispatch(onRestartGame());

  useEffect(() => {
    const handleOutsideClick = (e) => {
      if (
        !e.target.closest('.popup--show-df') &&
  ...
  return (
    <Portal>
      <div
        ref={endGameRef}
        className={classNames('popup', 'end-game-popup', 'fade', endGame, {
